...
namespace PUPiMed {
    ...
    public class rptStocks : ReportClass {
    ...
    public class CachedrptStocks : Component, ICachedReport {
        
        public CachedrptStocks() {
        }
