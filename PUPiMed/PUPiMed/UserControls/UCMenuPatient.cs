...
namespace PUPiMed
{
    public partial class UCMenuPatient : UserControl
    {
        private MainForm mainForm;
        private formMenu menu;
        private Color backColor1, backColor2, hover, selected;

        public UCMenuPatient(MainForm mainForm, formMenu menu)
        {
            InitializeComponent();
        ...
        private void UCMenuPatient_Load(object sender, EventArgs e)
        {
        ...
        {
            resetColor(sender);
            mainForm.changeUC(new UCStudentTab());
            ParentForm.Close();
        }

        private void tabFaculty_Click(object sender, EventArgs e)
        {
            resetColor(sender);
            mainForm.changeUC(new UCFacultyTab());
            ParentForm.Close();
        }
        ...
        {
            resetColor(sender);
            mainForm.changeUC(new UCAdminTab());
            ParentForm.Close();
        }
        ...
        private void tabRecords_Click(object sender, EventArgs e)
        {
            resetColor(sender);
            mainForm.changeUC(new UCRecords());
            ParentForm.Close();
        }
